...
import com.hoa.windchipi.payload.request.LoginRequest;
import com.hoa.windchipi.payload.request.SignupRequest;
import com.hoa.windchipi.payload.response.JwtResponse;
import com.hoa.windchipi.payload.response.MessageResponse;
...
import com.hoa.windchipi.security.services.UserDetailsImpl;
...
public class AuthController {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
		...
		System.out.println("full_name"+signUpRequest.getFull_name());
